...
namespace App\ClassesPHPExcelStyle;
 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcelStyleAlignment extends PHPExcel_Style_Supervisor 
{
	 ...
	 * @var string
	 */
	protected $_horizontal = PHPExcelStyleAlignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical = PHPExcelStyleAlignment::VERTICAL_CENTER;
	 ...
	 * @return PHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = PHPExcelStyleAlignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = PHPExcelStyleAlignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return PHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = PHPExcelStyleAlignment::VERTICAL_CENTER) {
		if ($pValue == '') {
			$pValue = PHPExcelStyleAlignment::VERTICAL_CENTER;
		}
